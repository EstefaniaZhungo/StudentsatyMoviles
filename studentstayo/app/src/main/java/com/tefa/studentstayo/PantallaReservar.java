...
import com.tefa.studentstayo.model.Callback;
...
public class PantallaReservar extends AppCompatActivity {
    ...
    public void buscarReser(final EncabezadoCallBack callBack) {
        String url = Environment.BASE_URL + "/reservas";//endpoint.
    ...
    public void buscarEcabezado(final Callback callback) {
        String url = Environment.BASE_URL + "/encabezadofactura";//endpoint.
    ...
    public void crearEncabezad() {
        buscarReser(new EncabezadoCallBack() {
            ...
            public void onReservaObtenido(long idReserva) {
                ...
                realizarSolicitudPOST(Environment.BASE_URL+"/encabezadofactura", encabezado);
    ...
    public void crearDetalle() {
        buscarEcabezado(new Callback() {
            ...
            public void onEncabezadoObtenido(long idEncabezado) {
                ...
                realizarSolicitudPOST(Environment.BASE_URL+"/detallefactura", detalle);
    ...
    public void getHabitacion(int id) {
        String url = Environment.BASE_URL + "/habitaciones/" + id;//endpoint.
    ...
    public void cambiarEstado(int id) {
        String url = Environment.BASE_URL + "/habitaciones/" + id;
